...
class TestEngine:
    ...
    def setup_class(cls):
        ...
        cls.data_test = {
            ...
            "stability": "medium",
            "weight": 100.5,
            "watts": 300.0  # Adding watts for HybridEngine
        }
    ...
    def test_create_engine(self):
        ...
        expected_str = (
            ...
            f"maximum_speed={maximum_speed}, "
            f"dimenssions={dimenssions}, "
            f"power={power}, "
            f"stability={stability}, "
            f"weight={weight}"
        )

        assert str(new_engine) == expected_str
    ...
    def test_liskov_hybrid_engine(self):
        ...
        assert str(new_hybrid_engine) == expected_str
